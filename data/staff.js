...
window.RACEUP_STAFF = [
  ...
  { empCode:'U12', nickname:'พลอย AE',nameTh:'วรัญญา ดิษฐ์เชยเดช',      nameEn:'Waranya',      role:'Account Executive',                    email:'waranya@raceup.co.th',       phone:'085-338-9155', phoneEmergency:'085-282-6739', department:'Project Management', level:'Execute', status:'Active', aliases:['พลอย-AE','Waranya'] },
  ...
  { empCode:'U23', nickname:'มาย',   nameTh:'ธนกร',                      nameEn:'Thanakorn',    role:'Marketing Officer',                    email:'Thanakorn@raceup.co.th',     phone:'095-163-2748', phoneEmergency:'',             department:'Media & PR',         level:'Execute', status:'Active', aliases:['มาย','Thanakorn'] },
